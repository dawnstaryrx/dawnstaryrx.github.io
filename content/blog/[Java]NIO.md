...
* 通过 RandomAccessFile 是否能读写根据构造 RandomAccessFile 时的读写模式决定 rw
...
public static void main(String[] args) throws IOException {
    ...
    Files.walkFileTree(Paths.get("D:\\Developer\\JDK11"), new SimpleFileVisitor<Path>(){
        @Override
    ...
    Files.walkFileTree(Paths.get("D:\\Developer\\JDK11"), new SimpleFileVisitor<Path>(){
        ...
        public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
            if (file.toString().endsWith(".jar")) {
                System.out.println("jarFile: " + file);
                jarCount.incrementAndGet();
            }
            return super.visitFile(file, attrs);
        }
    });
    System.out.println("dirCount: " + jarCount.get());
}
```
...
```java
Files.walkFileTree(Paths.get("C:\\Users\\rongx\\Desktop\\temp\\七年级"), new SimpleFileVisitor<Path>(){
    @Override
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
//                System.out.println("====> preVisitDirectory: " + dir);
        return super.preVisitDirectory(dir, attrs);
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2F3b9638a1e23e235165906d2db3fdc238-0023-ea598e.png)
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2F9beda40e996875e42ae18f1a4010cb0e-0033-384633.png)

* 阻塞 IO

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fd6140fbe21ad3029c901c39fc656c80f-0039-19eff4.png)

* 非阻塞  IO

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fbee47ff0353597736841cb77f39de290-0035-dad4c9.png)

* 多路复用

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2F92295a6cadbef7f318b447c195cfdaaf-0038-bea04f.png)

* 信号驱动

* 异步 IO

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fd24fd0f79f08ba57c427e8105d1b723b-0037-7f4cdb.png)

* 阻塞 IO vs 多路复用

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fb14515879b743602954685e6403970ad-0034-a50a71.png)

  ![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Ffe68785fc885d9bbfa4e9fa6a973dbe3-0036-1d0bcd.png)
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Ff89991c08c85fc0760ce56280440b6b6-0024-ca205a.png)
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fc3dd38c405a8e36fc37c50dde0478ed8-0025-f05fe8.png)
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Fded2b7613a6a8c4981724457f2157b22-0026-a6afba.png)
...
![](https://dawnstar-blog-1309734834.cos.ap-nanjing.myqcloud.com/img/2024%2F07%2F11%2Ff6c24eee6470e9511e439a78cbf37a99-0027-35c21f.png)
